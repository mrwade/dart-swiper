...
if((b.Gv===2?null:b.o4)!=null)new P.lF(z,x,w,b,r).$0()
if(q!=null)$.X3=q
if(x.d)return
if(x.b===!0){y=x.c
...
qE:{
"^":"cv;",
"%":"HTMLAppletElement|HTMLBRElement|HTMLBaseElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLImageElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLOptGroupElement|HTMLParagraphElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"},
Gh:{
"^":"qE;",
...
"^":"",
Yi:{
"^":"a;CY,lT,Sw,CI,bS,X7,Jt,C7,ot,Vc,bX,Xf,KX,Pt,rV,uX",
...
if(!a&&P.p8("TouchEvent")){$.ed().Ny("Installing drag start listener (touchStart).")
z=this.Vc
z.toString
z=C.BD.f0(z)
z=H.VM(new W.xC(0,z.uv,z.Ph,W.VF(this.gOh()),z.Sg),[H.Kp(z,0)])
z.Zz()
this.bX.push(z)}if(!b){$.ed().Ny("Installing drag start listener (mouseDown).")
z=J.GW(this.Vc)
...
x=x[0]
if(!this.jS(z,y,H.VM(new P.hL(x.pageX,x.pageY),[null])))return
$.ed().Ny("TouchStart event: "+J.AG(this.KX))
z=this.Xf
y=C.Db.aM(document)
...
if(typeof z!=="number")return H.s(z)
v=H.VM(new P.hL(y-x,w-z),[H.Kp(a,0)])
if(this.CY){z=v.y
z.toString
z=Math.abs(z)
y=v.x
...
if(J.Ql(a)!==0)return
if(!this.jS(W.jj(a.currentTarget),W.jj(a.target),H.VM(new P.hL(a.pageX,a.pageY),[null])))return
$.ed().Ny("MouseDown event: "+J.AG(this.KX))
z=this.Xf
y=C.Cm.aM(document)
...
if(z){$.ed().Ny("Drag started on a cancel element, canceling drag.")
return!1}return!0},
Dr:function(){var z,y
z=this.Xf
y=C.rl.aM(window)
...
if(this.uX){$.ed().Ny("DragEnd: "+H.d(b))
z=this.ot
if(z!=null){y=this.rV
x=this.KX
if(z.Gv>=4)H.vh(z.q7())
...
z.e6(a)
if(!!z.$isAj)this.JF()}else $.ed().Ny("No dragging detected.")
...
"^":"Tp:22;a",
$1:function(a){var z,y
if(J.m5(a).length>1){$.ed().Ny("Canceling because of multi-touch gesture.")
z=a.touches
if(0>=z.length)return H.e(z,0)
z=z[0]
this.a.SH(a,H.VM(new P.hL(z.pageX,z.pageY),[null]))}else{z=a.changedTouches
if(0>=z.length)return H.e(z,0)
z=z[0]
y=H.VM(new P.hL(z.pageX,z.pageY),[null])
z=this.a
if(!z.uX&&z.xP(y)){$.ed().Ny("User is scrolling, canceling drag.")
z.n8()
...
if(0>=z.length)return H.e(z,0)
z=z[0]
this.b.SH(a,H.VM(new P.hL(z.pageX,z.pageY),[null]))}},
rN:{
"^":"Tp:23;a",
...
"^":"Tp:12;a",
$1:function(a){var z
if(J.Zm(a)===27){$.ed().Ny("Esc-key pressed, ending drag.")
z=this.a
z.jj(a,z.Pt,!0)}}},
nb:{
"^":"Tp:12;b",
$1:function(a){var z
$.ed().Ny("Window focus lost, ending drag.")
z=this.b
z.jj(a,z.Pt,!0)}},
Qb:{
"^":"Tp:12;",
$1:function(a){$.ed().Ny("Suppressing click event.")
J.tW(a)
a.preventDefault()}},
CS:{
"^":"Tp:11;a",
...
"^":"",
QL:[function(){S.Cw(document.querySelector(".swiper"),0.666,!0,"input,textarea,button,select,option",!1,!1,20,"swiper-drag-occurring","swiper-dragging",250,null,300,0)},"$0","HA",0,0,11]},1],["html_common","dart:html_common",,P,{
"^":"",
...
J.HT(J.qk(x),"translate3d("+-a*100+"%, 0, 0)")},
nS:function(){$.qc().Ny("Transition end event: index="+H.d(this.G9))
this.d8=!1},
hQ:function(a,b,c){var z,y,x,w
a=this.TM(a)
z=$.qc()
z.Ny("Moving to index: index="+a+", speed="+c)
y=c>0
x=this.Bf
w=a*-100
if(y){x=J.qk(x)
J.RE(x).sDc(x,"transform")
C.rd.sOf(x,""+c+"ms")
C.rd.siy(x,"ease-out")
J.HT(J.qk(this.Bf),"translate3d("+w+"%, 0, 0)")}else J.HT(J.qk(x),"translate3d("+w+"%, 0, 0)")
if(a!==this.G9&&!b){z.Ny("Page change event: index="+a)
if(y)this.d8=!0
...
J.OE(z,""+C.CD.yu(C.CD.UD(y*this.TW))+"px")},
...
J.HT(J.qk(this.Bf),"translate3d("+H.d(z*-y+x)+"px, 0, 0)")},"$1","ghp",2,0,24],
...
x=y<x-1
y=x}else y=!1
if(y){if(typeof z!=="number")return z.g();++z}else{if(!v){y=this.G9
if(typeof y!=="number")return y.D()
y=y>0}else y=!1
if(y){if(typeof z!=="number")return z.W();--z}}}}y=this.G9
if(z==null?y!=null:z!==y){y=this.NO
x=Math.abs(w)
if(typeof y!=="number")return y.W()
u=Math.abs(y-x)}else u=Math.abs(w)
this.M7(z,this.an(this.EB,u))},"$1","gMw",2,0,24],
TM:function(a){if(typeof a!=="number")return a.C()
if(a<0)return 0
if(a>J.q8(J.OG(this.Bf))-1)return J.q8(J.OG(this.Bf))-1
return a},
...
$.ed().Ny("Initializing DragDetector.")
z.Xc(f,e)
this.lD=z
z.CY=!0
y=this.Gp
...
I.$lazy($,"_log","DG","ed",function(){return N.Jx("dnd.drag_detector")})
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
function Yi(CY,lT,Sw,CI,bS,X7,Jt,C7,ot,Vc,bX,Xf,KX,Pt,rV,uX){this.CY=CY
this.lT=lT
this.Sw=Sw
this.CI=CI
this.bS=bS
